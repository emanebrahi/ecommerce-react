...
import Qrcode from "../imges/qrcode.jpeg";
import Googlestore from "../imges/googleplay.png";
      ...
      <div className="container footer-container">
        <div className="row">
          <div className="col-lg-3 col-md-6 col-sm-12 col-12">
            ...
            <input
              className="bg-dark border border-1"
              type="Email"
          ...
          <div className="col-lg-3 col-md-6 col-sm-12 col-12">
            ...
            <p className="mb-0">exclusive@gmail.com</p>
          ...
          <div className="col-lg-2 col-md-6 col-sm-12 col-12">
            ...
            <div className="d-flex flex-column">
              ...
              <NavLink to="/login.js" style={styleLink}>
                Login/Register
              </NavLink>
              <NavLink to="" style={styleLink}>
                Cart
          ...
          <div className="col-lg-2 col-md-6 col-sm-12 col-12">
            ...
            <p className="mb-0">turns of use</p>
            <p className="mb-0">FAQ</p>
            <NavLink to="" style={styleLink}>
              Contact
            </NavLink>
          </div>
          <div className="col-lg-2 col-md-6 col-sm-12 col-12 m-auto">
            <h5 className="footer-title">Download App</h5>
            <p>Save $3 with App New User Only</p>

            <div className="row images-footer-container">
              <div className="col-lg-6 col-md-6 col-sm-12 col-12 m-0 ">
                <img className="qrcode overflow-hidden" src={Qrcode} />
              </div>

              <div className="col-lg-6 col-md-6 col-sm-12 col-12 d-flex flex-column  m-0 p-0">
                <img className="store" src={Googlestore} />
                <img className="store" src={Appstore} />
              </div>
